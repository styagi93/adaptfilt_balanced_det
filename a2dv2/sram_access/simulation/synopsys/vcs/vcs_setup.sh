...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/sram_access_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv \
  $QSYS_SIMDIR/submodules/sram_access_mm_interconnect_0_avalon_st_adapter.v \
  ...
  $QSYS_SIMDIR/submodules/sram_access_mm_interconnect_0_rsp_mux.sv \
  $QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv \
  $QSYS_SIMDIR/submodules/sram_access_mm_interconnect_0_rsp_demux.sv \
  $QSYS_SIMDIR/submodules/sram_access_mm_interconnect_0_cmd_mux.sv \
  $QSYS_SIMDIR/submodules/sram_access_mm_interconnect_0_cmd_demux.sv \
  ...
  $QSYS_SIMDIR/submodules/sram_access_jtag_master_p2b_adapter.sv \
  $QSYS_SIMDIR/submodules/sram_access_jtag_master_b2p_adapter.sv \
  ...
  $QSYS_SIMDIR/submodules/sram_access_jtag_master_timing_adt.sv \
