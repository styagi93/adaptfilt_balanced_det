...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/auk_dspip_math_pkg.vhd"        -work cic_ii_0
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/auk_dspip_text_pkg.vhd"        -work cic_ii_0
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/auk_dspip_lib_pkg.vhd"         -work cic_ii_0
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/auk_dspip_delay.vhd"           -work cic_ii_0
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/auk_dspip_fastaddsub.vhd"      -work cic_ii_0
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/auk_dspip_fastadd.vhd"         -work cic_ii_0
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/auk_dspip_pipelined_adder.vhd" -work cic_ii_0
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/auk_dspip_roundsat.vhd"        -work cic_ii_0
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/CIC_cic_ii_0.sv"               -work cic_ii_0
