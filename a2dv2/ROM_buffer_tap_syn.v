...
//altsyncram ADDRESS_ACLR_A="NONE" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone IV E" ENABLE_RUNTIME_MOD="YES" INIT_FILE="buffer_tap.hex" INSTANCE_NAME="BUFF" NUMWORDS_A=1 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="CLOCK0" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=1 address_a clock0 q_a
...
module  ROM_buffer_tap_altsyncram1
	( 
	address_a,
	address_b,
	clock0,
...
`endif
	...
	defparam
		...
		ram_block3a_0.init_file = "buffer_tap.hex",
	...
	defparam
		...
		ram_block3a_1.init_file = "buffer_tap.hex",
	...
	defparam
		...
		ram_block3a_2.init_file = "buffer_tap.hex",
	...
	defparam
		...
		ram_block3a_3.init_file = "buffer_tap.hex",
	...
	defparam
		...
		ram_block3a_4.init_file = "buffer_tap.hex",
	...
	defparam
		...
		ram_block3a_5.init_file = "buffer_tap.hex",
	...
	defparam
		...
		ram_block3a_6.init_file = "buffer_tap.hex",
	...
	defparam
		...
		ram_block3a_7.init_file = "buffer_tap.hex",
	...
	assign
		...
		wren_a = 1'b0;
endmodule //ROM_buffer_tap_altsyncram1

//synthesis_resources = M9K 1 sld_mod_ram_rom 1 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  ROM_buffer_tap_altsyncram
	( 
	address_a,
	clock0,
...
`endif
	...
	ROM_buffer_tap_altsyncram1   altsyncram1
	( 
	.address_a(address_a),
	...
	defparam
		...
		mgl_prim2.node_name = 1112884806,
	...
	initial/*synthesis enable_verilog_initial_construct*/
 	begin
		$display("Warning: MGL_INTERNAL_WARNING: (Invalid line found in memory file.  Invalid line --  -- found in file buffer_tap.hex)  ");
		$display("Warning: Memory initialization file buffer_tap.hex is not found. This may result in inconsistent simulation results.");
	end
endmodule //ROM_buffer_tap_altsyncram
//VALID FILE
...
`endif
	...
	ROM_buffer_tap_altsyncram	ROM_buffer_tap_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.q_a (sub_wire0));
