<sld_project_info>
  <sld_infos>
    <sld_info hpath="CIC:u0" name="u0">
      <assignment_values>
        <assignment_value text="QSYS_NAME CIC HAS_SOPCINFO 1 GENERATION_ID 1502268978"/>
      </assignment_values>
    </sld_info>
    <sld_info hpath="p_sine:p_sine_inst" name="p_sine_inst">
      <assignment_values>
        <assignment_value text="QSYS_NAME p_sine HAS_SOPCINFO 1 GENERATION_ID 1504260501"/>
      </assignment_values>
    </sld_info>
    <sld_info hpath="sram_access:sram_abc" name="sram_abc">
      <assignment_values>
        <assignment_value text="QSYS_NAME sram_access HAS_SOPCINFO 1 GENERATION_ID 1504259397"/>
      </assignment_values>
    </sld_info>
