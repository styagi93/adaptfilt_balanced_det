...
% ================================================================================
% Generated on: 07/11/2016 15:51:23
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = fir_IP_mlab(single_channel_data{i}, single_channel_bank{i});
